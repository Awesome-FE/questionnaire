        ...
        <div class="w clearfix">
            <div class="myOrder_tab_body detail_content" v-cloak>
                ...
                <div class="product_inventory independent_product_inventory">
                    ...
                    <div class="immediately_buy clearfix"><router-link class="pay" target="_blank" v-if="orderStatus == 99" :to="{path: '/payWayThird', query: {orderId: orderId, productDesc: productName, orderSn: orderSn, totalPrice: orderPrice, orderType: '4'}}">支付</router-link></div>
                </div>
            </div>
        </div>
    </div>
      ...
      axios
        ...
        .then(function(response) {
          ...
          Object.assign(vm, {
            ...
            innovationList: resData.data.goodsItems,
